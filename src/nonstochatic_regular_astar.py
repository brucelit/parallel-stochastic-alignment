...
class AlignmentWithRegularAstar:
    ...
    def search(self):
        ...
        ini_state = SearchTuple(0 + h, 0, h, self.ini, None, None, x, True)
        open_set = [ini_state]
        self.num_insert += 1
...
if __name__ == '__main__':
    log_path = "../log/hospital_variants.xes"
    model_path = '../model/hospital_sub5.pnml'
